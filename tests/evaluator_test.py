...
class TestEvaluator(unittest.TestCase):
    ...
    def test_measure_words_correlation(cls):
        print(os.getcwd())
        os.environ['PROJECT_PATH'] = 'bnn_language_models'
        config = yaml.load(
        ...
        # cls.assertEqual(list(evaluation_data.keys()), ["pearson score", "p-val", "oov pairs"], "Error in test_measure_words_correlation")
    ...
    def test_measure_word_analogy_accuracy(cls):
        ...
        print(validation_analogy_df.columns)
        ...
        print(model.central_embeddings)
